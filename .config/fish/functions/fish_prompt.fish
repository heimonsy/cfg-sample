...
function __heimonsy_prompt_system -S -d 'display system symbols'
  set uname (uname)
  if [ $uname = "Darwin" ]
    __bobthefish_start_segment $__color_system_mac
    echo -ns ' '
    set_color normal
  else if [ $uname = "Linux" ]
    set hname (hostname)
    if [ $hname = "heimonsy-ub" ]
        __bobthefish_start_segment $__color_system_ubuntu
        #echo -ns ' '
        echo -ns ' '
        set_color normal
    else
        __bobthefish_start_segment $__color_system_vm
        #echo -ns ' '
        echo -ns ' '
        set_color normal
    end
...
function fish_prompt -d 'bobthefish, a fish theme optimized for awesome'
  ...
  switch "$theme_color_scheme"
    ...
    case '*' # default dark theme
      ...
      set __color_system_vm                e95320 f8f8f8 --bold
      set __color_system_mac               cecece fafafa
      set __color_system_ubuntu            cecece e95320 --bold
      set __color_system_box               cecece 1973e8 --bold
  end
